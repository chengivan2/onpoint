...
export default function HerosectionOne() {
  return (
    <section className="relative px-[0.1rem] lg:px-[1rem] mt-20 py-[0.8rem] lg:py-[2rem] min-w-full min-h-[100vh]">
      ...
      <div className="relative px-[0.1rem] py-[0.1rem] min-w-full h-[98vh] rounded-[0.8rem] bg-cover bg-center bg-[url(/images/onpointherolightmoodebg.png) dark:bg-[url(/images/onpointherodarkmoodebg.png)]">
